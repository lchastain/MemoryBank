...
public class SearchPanel extends JPanel
{
  ...
  public boolean filterLastMod(Date d) {
    ...
    case AFTER:
      if(d.before(dateMod1)) rv = false;
      break;
    case BEFORE:
      if(d.after(dateMod1)) rv = false;
      break;
    case BETWEEN:
      if(d.before(dateMod1)) rv = false;
      if(d.after(dateMod2)) rv = false;
      break;
    } // end switch
  ...
  public boolean filterWhen(Date d) {
    ...
    case AFTER:
      if(d.before(dateWhen1)) rv = false;
      break;
    case BEFORE:
      if(d.after(dateWhen1)) rv = false;
      break;
    case BETWEEN:
      if(d.before(dateWhen1)) rv = false;
      if(d.after(dateWhen2)) rv = false;
      break;
    } // end switch
  ...
  public boolean getAnd1() { return rbtnAnd1.isSelected(); }
  public boolean getAnd2() { return rbtnAnd2.isSelected(); }
  
  // This method is only here to 'fool' JFramebuilder-generated code.
  public JPanel getContentPane() {  return SearchPanel.this;   }

  public Date getDateMod1() { return dateMod1; }
  public Date getDateMod2() { return dateMod2; }
  public Date getDateWhen1() { return dateWhen1; }
  public Date getDateWhen2() { return dateWhen2; }
  ...
  public boolean getNot1() { return chkboxNot1.isSelected(); }
  public boolean getNot2() { return chkboxNot2.isSelected(); }
  public boolean getNot3() { return chkboxNot3.isSelected(); }

  public boolean getOr1() { return rbtnOr1.isSelected(); }
  public boolean getOr2() { return rbtnOr2.isSelected(); }
  ...
  public SearchPanelSettings getSettings() {
    ...
    sps.dateWhen1 = getDateWhen1();
    sps.dateWhen2 = getDateWhen2();
    sps.whenChoice = getWhenSetting();

    sps.dateMod1 = getDateMod1();
    sps.dateMod2 = getDateMod2();
  ...
  //--------------------------------------------------------------------
  public static String getSummary(SearchPanelSettings sps) {
    ...
    switch(intMakeup) {
    case 1:
      if(sps.not1) strNot = "NOT "; else strNot = "";
      s = "Search Text was: " + strNot + sps.word1;
      break;
    case 2:
      if(sps.not2) strNot = "NOT "; else strNot = "";
      s = "Search Text was: " + strNot + sps.word2;
      break;
    case 3:
      if(sps.and1) strAnd = " AND "; else strAnd = "";
      if(sps.or1) strOr = " OR "; else strOr = "";
      ...
      break;
    case 4:
      if(sps.not3) strNot = "NOT "; else strNot = "";
      s = "Search Text was: " + strNot + sps.word3;
      break;
    case 5:
      if(sps.and2) strAnd = " AND "; else strAnd = "";
      if(sps.or2) strOr = " OR "; else strOr = "";
  ...
  private void handleDateSpecChange(JRadioButton source, boolean rc) {
    ...
    if(rc) { // We are deselecting -
      ...
      if(strWhich.contains("When")) {
        if(dateWhen1 != null) yvDateChooser.setChoice(dateWhen1);
        else yvDateChooser.setChoice(null);

        showDateDialog(strPrompt, intChoiceCount);
        if(blnDialogClosed) {
          if(dateWhen1 == null) handleDateSpecChange(source, true);
          if((intChoiceCount == 2) && (dateWhen2 == null)) handleDateSpecChange(source, true);
        } else {
          dateWhen1 = yvDateChooser.getChoice();
          if(intChoiceCount == 2) {
            Date dateTmp = yvDateChooser.getChoice2();
            dateWhen2 = dateWhen1;
            if(dateTmp.before(dateWhen1)) dateWhen1 = dateTmp;
            else dateWhen2 = dateTmp;
          } // end if
        } // end if
      } else {  //      "Mod"
        if(dateMod1 != null) yvDateChooser.setChoice(dateMod1);
        else yvDateChooser.setChoice(null);

        showDateDialog(strPrompt, intChoiceCount);
        if(blnDialogClosed) {
          if(dateMod1 == null) handleDateSpecChange(source, true);
          if((intChoiceCount == 2) && (dateMod2 == null)) handleDateSpecChange(source, true);
        } else {
          dateMod1 = yvDateChooser.getChoice();
          if(intChoiceCount == 2) {
            Date dateTmp = yvDateChooser.getChoice2();
            dateMod2 = dateMod1;
            if(dateTmp.before(dateMod1)) dateMod1 = dateTmp;
            else dateMod2 = dateTmp;
          } // end if
        } // end if
      } // end if
    } // end if
...
//  pnlWhere.setVisible(false);
  ...
  private void resetDateDisplay() {
    ...
    if(dateWhen1 != null) {
      s = "<html>" + sdf.format(dateWhen1);
      if(dateWhen2 != null) {
        s += "<br>&nbsp;&nbsp;&nbsp;&nbsp;and<br>" + sdf.format(dateWhen2);
      } // end if
      s += "</html>";
      lblWhenSelected.setText(s);
    ...
    if(dateMod1 != null) {
      s = "<html>" + sdf.format(dateMod1);
      if(dateMod2 != null) {
        s += "<br>&nbsp;&nbsp;&nbsp;&nbsp;and<br>" + sdf.format(dateMod2);
      } // end if
      s += "</html>";
      lblModSelected.setText(s);
  ...
  public boolean searchGoals() { return chkboxGoals.isSelected(); } 
  public boolean searchDays() { return chkboxDayNotes.isSelected(); } 
  public boolean searchMonths() { return chkboxMonthNotes.isSelected(); } 
  public boolean searchYears() { return chkboxYearNotes.isSelected(); }
  public boolean searchEvents() { return chkboxEvents.isSelected(); }
  public boolean searchLists() { return chkboxTodoLists.isSelected(); }

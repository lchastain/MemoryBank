/* ***************************************************************************
 *
 * File:  $Id: EventNoteComponent.java,v 1.1 2006/07/22 02:03:49 lee Exp $
 *
 * Author:  D. Lee Chastain
 *
 * $Log: EventNoteComponent.java,v $
...
class EventNoteData extends IconNoteData {
  ...
  public String getDateFormat() { return strDateFormat; }
  ...
  public Date getEventEnd() { return dateEventEnd; }
  public Date getEventStart() { return dateEventStart; }
  

  public String getLocation() { return strLocation; }

  //  @Override not needed, but trying to learn annotations.. 
  @Override protected Date getNoteDate() {
    return getStartDate(); 
  } // end getNoteDate

  public String getRecurrence() { return strRecurrence; }

  public boolean getRetainNote() { return blnRetainNote; }
...
//    System.out.println("  End Time known: " + end.isEndTimeKnown());
  ...
  public void setDateFormat(String s) { strDateFormat = s; }
 ...
 public void setLocation(String s) { strLocation = s; }
 
 public void setRecurrence(String s) { strRecurrence = s; }
 
 public void setRetainNote(boolean b) { blnRetainNote = b; }

...
public class LogIcon extends ImageIcon {
  ...
  public class WinIcon {
    ...
    public int getWidth() { return entry.width; }
    public int getHeight() { return entry.height; }
  ...
  private class IconFile {
    ...
    public WinIcon getIcon() { return getIcon(32,32); }
  ...
  private class BitmapHeader {
    ...
    public BitmapHeader() { valid = false; }
  ...
  public class WinInputStream extends DataInputStream {
    ...
    public int readUnsignedShortX() throws IOException {
      ...
      int[] is = new int[2];
      read(buf);
      for (int i=0; i<2; i++) { is[i] = (buf[i] + 256) % 256; }
      return (is[1] << 8) | is[0];
    }
    ...
    public int readIntX() throws IOException {
      ...
      int[] is = new int[4];
      read(buf);
      for (int i=0; i<4; i++) { is[i] = (buf[i] + 256) % 256; }

/* ***************************************************************************
 *
 * File:  $Id: DayNoteGroup.java,v 1.1 2006/07/22 02:03:49 lee Exp $
 *
 * Author:  D. Lee Chastain
 *
 * $Log: DayNoteGroup.java,v $
 * Revision 1.1  2006/07/22 02:03:49  lee
 * New file in support of a Data/Component Note hierarchy.
 *
 * This file comes from the original 'NoteGroup', which until now had 
 * been a day-centric collection anyway.  Now, that
 * class has been stripped of the day-specific behaviors that are here,
 * and this one is an extension of that generic base class, PLUS the
 * originally extended NoteGroup methods that were previously in the
 * 'DayNotes' class, which no longer exists.  The interactive header that
 * was in DayNotes is now found in LogDays, and it interacts with
 * its instance of this class via public calls.
 ****************************************************************************/
...
public class DayNoteGroup extends CalendarNoteGroup 
  ...
  public LogIcon getDefaultIcon() { return defaultIcon; }
  ...
  public static void loadDefaults() {
    ...
    try {
      ...
      saveDefaults();
      return;
    } catch (EOFException eofe) {  e = eofe;

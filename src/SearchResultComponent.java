...
public class SearchResultComponent extends NoteComponent {
  ...
  public JComponent getFoundInButton() { return fibTheFoundInButton; }

  public JComponent getLastModLabel() { return lmlTheLastModLabel; }
...
class SearchResultData extends NoteData implements Serializable {
  ...
  public File getFileFoundIn() { return fileFoundIn; }

  protected Date getNoteDate() { return dateNoteWhen; }
  ...
  public void setFileFoundIn(File f) { fileFoundIn = f; }

  public void setNoteDate(Date value) { dateNoteWhen = value; }

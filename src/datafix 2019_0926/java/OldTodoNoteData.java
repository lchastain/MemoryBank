...
public class OldTodoNoteData extends NoteData implements Serializable {
    ...
    public OldTodoNoteData(OldTodoNoteData tndCopy) {
        super(tndCopy);
    ...
    public OldTodoNoteData(NoteData nd) {
        super(nd);
        clearTodoNoteData(); // sets default values.
    } // end constructor
    ...
    protected NoteData copy( ) {
        return new OldTodoNoteData(this);
    }

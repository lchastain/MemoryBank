...
class SearchResultGroupTest {
    ...
    void beforeEach() throws InterruptedException {
        ...
        searchResultGroup = (SearchResultGroupPanel) GroupPanelFactory.loadNoteGroup("Search Result", theNodeName);
    ...
    void testLoadLastModDate() {
        ...
        SearchResultGroupPanel srg = (SearchResultGroupPanel) GroupPanelFactory.loadNoteGroup("Search Result", theFileName);

...
// Not ready for prime-time; not currently working this...

public class RichNoteGroupPanel extends NoteGroupPanel {
    private static final Logger log = LoggerFactory.getLogger(RichNoteGroupPanel.class);
    private static final int DEFAULT_PAGE_SIZE = 25;
    GroupProperties groupProperties;

    public RichNoteGroupPanel(GroupInfo groupInfo, int pageSize) {
        super(pageSize);
    ...
    public RichNoteGroupPanel(GroupInfo groupInfo) {

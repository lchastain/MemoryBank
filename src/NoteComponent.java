...
public class NoteComponent extends JPanel {
  ...
  public JComponent getNoteTextField() { return noteTextField; }
...
//    noteTextField.transferFocusUpCycle();  // new.. 3/19/2008
  ...
  DocumentListener, FocusListener, MouseListener {
    ...
    public String getExtText() { return getNoteData().getExtendedNoteString(); }
    public String getSubject() { return getNoteData().getSubjectString(); }
...
class NoteData implements Serializable {
  ...
  public int getExtendedNoteHeightInt() { return extendedNoteHeightInt; }
  public String getExtendedNoteString() { return extendedNoteString; }
  public int getExtendedNoteWidthInt() { return extendedNoteWidthInt; }
  protected Date getNoteDate() { return null; }
  public String getNoteId() { return strNoteId; }
  public String getNoteString() { return noteString; }
  public Date getLastModDate() { return dateLastMod; }
  public String getSubjectString() { return subjectString; }
  ...
  public void setExtendedNoteHeightInt(int val) { extendedNoteHeightInt = val; }
  ...
  public void setExtendedNoteWidthInt(int val) { extendedNoteWidthInt = val; }

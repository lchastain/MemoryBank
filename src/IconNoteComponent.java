...
public abstract class IconNoteComponent extends NoteComponent {
  ...
  static {
	...
	return false;
      ...
      public String getDescription() { return "icon images";
      } // end getDescription
    };
...
class IconNoteData extends NoteData implements Serializable {
  ...
  public String getIconFileString() { return iconFileString; }
  public boolean getShowIconOnMonthBoolean() { return showIconOnMonthBoolean; }
  
  public void setIconFileString(String val) { iconFileString = val; }
  public void setShowIconOnMonthBoolean(boolean val) { showIconOnMonthBoolean = val; }
